...
public class Oneal extends Mob {
    private static LinkedList<Image> oneal = null;
    ...
    public static void init() {
        if (oneal == null) {
            try {
                oneal = new LinkedList<>();
                oneal.add(new Image(Oneal.class.getResource("/assets/mobs/oneal/mob1.png").toURI().toString()));
                oneal.add(new Image(Oneal.class.getResource("/assets/mobs/oneal/mob2.png").toURI().toString()));
                oneal.add(new Image(Oneal.class.getResource("/assets/mobs/oneal/mob3.png").toURI().toString()));
                oneal.add(new Image(Oneal.class.getResource("/assets/mobs/oneal/mob4.png").toURI().toString()));
                oneal.add(new Image(Oneal.class.getResource("/assets/mobs/oneal/mob5.png").toURI().toString()));
                oneal.add(new Image(Oneal.class.getResource("/assets/mobs/oneal/mob6.png").toURI().toString()));
                oneal.add(new Image(Oneal.class.getResource("/assets/mobs/oneal/mob7.png").toURI().toString()));
                oneal.add(new Image(Oneal.class.getResource("/assets/mobs/oneal/mob8.png").toURI().toString()));
                oneal.add(new Image(Oneal.class.getResource("/assets/mobs/oneal/mob9.png").toURI().toString()));
                oneal.add(new Image(Oneal.class.getResource("/assets/mobs/oneal/mob10.png").toURI().toString()));
    ...
    public void draw(GraphicsContext render) {
        if (!deading) {
            ...
            if (moveVerti == 0 && moveHori == 0) {
                render.drawImage(oneal.get(status), x, y);
            } else {
                render.drawImage(oneal.get(status + statusAnimation), x, y);
            }
            timeAnimation++;
            if (timeAnimation == 20) {
                statusAnimation++;
    ...
    public void deadAnimation(GraphicsContext render) {
        ...
        render.fillText(" + 400", x + 26, y + 20 - timeDeadAnimation / 5);
        render.drawImage(oneal.get(6 + deadStatus), x, y);
    }
    ...
    public void setSurvival(boolean survival) {
        if (!this.deading) {
            ...
            PlayWindow.SCORE += 400;
            PlayWindow.BONUSLIFE += 400;
            isLastEnemy();
        }
    }
