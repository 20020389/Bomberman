...
public class Doll extends Mob {
    private static LinkedList<Image> doll;
    ...
    public static void init() {
        if (!INIT) {
            doll = new LinkedList<>();
            try {
                doll.add(new Image(Doll.class.getResource("/assets/mobs/doll/mob1.png").toURI().toString()));
                doll.add(new Image(Doll.class.getResource("/assets/mobs/doll/mob2.png").toURI().toString()));
                doll.add(new Image(Doll.class.getResource("/assets/mobs/doll/mob3.png").toURI().toString()));
                doll.add(new Image(Doll.class.getResource("/assets/mobs/doll/mob4.png").toURI().toString()));
                doll.add(new Image(Doll.class.getResource("/assets/mobs/doll/mob5.png").toURI().toString()));
                doll.add(new Image(Doll.class.getResource("/assets/mobs/doll/mob6.png").toURI().toString()));
                doll.add(new Image(Doll.class.getResource("/assets/mobs/doll/mob7.png").toURI().toString()));
                doll.add(new Image(Doll.class.getResource("/assets/mobs/doll/mob8.png").toURI().toString()));
                doll.add(new Image(Doll.class.getResource("/assets/mobs/doll/mob9.png").toURI().toString()));
                doll.add(new Image(Doll.class.getResource("/assets/mobs/doll/mob10.png").toURI().toString()));
    ...
    public void draw(GraphicsContext render) {
        if (!deading) {
            ...
            render.drawImage(doll.get(status + statusAnimation), x, y);
            timeAnimation ++;
            if (timeAnimation == 20) {
                statusAnimation++;
                timeAnimation = 0;
    ...
    public void deadAnimation(GraphicsContext render) {
        ...
        render.fillText(" + 600", x + 26, y + 20 - timeDeadAnimation / 5);
        render.drawImage(doll.get(6 + deadStatus), x, y);
    }
    ...
    public void setSurvival(boolean survival) {
        if (!this.deading) {
            ...
            PlayWindow.SCORE += 600;
            PlayWindow.BONUSLIFE += 600;
            isLastEnemy();
        }
    }
